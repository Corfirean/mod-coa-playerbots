...
--
-- Vendored for WoW 3.3.5a (WotLK): the upstream r56 release's numeric SetTexture() ids
-- (136477/136430/136467) are Legion-era FileDataIDs that this client can't resolve -- patched
-- back to the equivalent string texture paths named in the original's own comments.
--
